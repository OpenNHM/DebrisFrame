...
if __name__ == "__main__":
    ...
    relThVal = [0.181,1.447,2.062,1.845,1.628,1.411,1.194,0.977,0.760,0.543,0.326,0.109]
    ...
    c1tiCfg = cfgUtils.getModuleConfig(c1Ti)
    defaultCfg = cfgUtils.getModuleConfig(
        com1DFA, onlyDefault=c1tiCfg["com1DFA_com1DFA_override"].getboolean("defaultConfig")
    )
    cfgDebris,_ = cfgHandling.applyCfgOverride(defaultCfg, c1tiCfg, com1DFA, addModValues=False)
